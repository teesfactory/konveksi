...
<div class="wrap container-fluid">
	<h1 class="wp-heading-inline">Penjualan Lainnya</h1>
	...
	<ul class="subsubsub">
		...
		<li class="publish"><a href="admin.php?page=konveksi-penjualan&pg=penjualan-lainnya" class="current" aria-current="page">Penjualan Lain-lain</a></li>
	</ul> 
	<div class="clear"></div>
  <form id="form-penjualan" action="admin.php?page=konveksi-penjualan" method="post">
    ...
    <input type="hidden" name="poscode" value="002">
