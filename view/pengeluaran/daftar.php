...
<div class="wrap container-fluid">
  <h1 class="wp-heading-inline">Daftar Pengeluaran</h1>
  <hr class="wp-header-end">
  <ul class="subsubsub">
    <li class="all"><a href="admin.php?page=konveksi-pengeluaran" class="current" aria-current="page">Daftar Pengeluaran</a> |</li>
    <li class="publish"><a href="admin.php?page=konveksi-pengeluaran&pg=belanja-kaos">Belanja Kaos</a> |</li>
    <li class="publish"><a href="admin.php?page=konveksi-pengeluaran&pg=belanja-bahan">Belanja Bahan</a> |</li>
    <li class="publish"><a href="admin.php?page=konveksi-pengeluaran&pg=biaya-operasional-produksi">Biaya Produksi & Operasional</a> |</li>
    <li class="publish"><a href="admin.php?page=konveksi-pengeluaran&pg=transfer-kas">Transfer Kas</a></li>
  </ul> 
  <p class="search-box">
...
<!-- https://www.wasap.at/#result-card -->